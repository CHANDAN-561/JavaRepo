...
public class Main {
    public static void main(String[] args) {
        ...
        // System.out.println(System.lineSeparator() + "This is a " + nissan.getMake() +
        // " car. " + "It's a " + nissan.getYear() + " model, " + nissan.getColor() + "
        // color. It costs around " + (int) nissan.getPrice() + " $" +
        // System.lineSeparator() + "Available spare parts are: " + Arrays.toString
        // (nissan.getParts()));

        // System.out.println(System.lineSeparator() + "This is an " + audi.getMake() +
        // " car. " + "It's a " + audi.getYear() + " model, " + audi.getColor() + "
        // color. It costs around " + (int) audi.getPrice() + " $" +
        // System.lineSeparator() + "Available spare parts are: " + Arrays.toString
        // (audi.getParts()));
        ...
        // is " + nissan2.getMake() + " car. " + "It's a " + nissan2.getYear() + "
        // model, " + nissan2.getColor() + " color. It costs around " + (int)
        // nissan2.getPrice() + " $" + System.lineSeparator() + "Available spare parts
        // are: " + Arrays.toString (nissan2.getParts()));
